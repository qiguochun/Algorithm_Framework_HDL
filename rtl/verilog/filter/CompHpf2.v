...
//Moudle Name       :   CompHpf2.v
//Original Author   :   HDL-Auto
//Creation Date     :   2026.09.06
/*Description       :   二阶巴特沃斯高通滤波器（双线性/Tustin 离散，IIR）。
                        连续 H(s)=s^2/(s^2+sqrt(2)*wc*s+wc^2)，wc=2*pi*fc。
                        s=K*(z-1)/(z+1)，K=2fs，记 C=K^2+sqrt2*wc*K+wc^2：
                        分母 z^0..z^2 系数 = K^2,(2wc^2-2K^2),(K^2-sqrt2 wc K+wc^2)；
