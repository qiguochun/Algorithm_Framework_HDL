...
module CompBpf2 #(
    ...
    parameter integer F0         = 250,    // 中心频率 Hz，wc=2*pi*F0
    ...
    localparam integer COEF_B0 = fn_bpf2_b0(FS, F0, QREF, FSHIFT);
    localparam integer COEF_B1 = 0;
    localparam integer COEF_B2 = -COEF_B0;
    localparam integer COEF_A1 = fn_bpf2_a1(FS, F0, QREF, FSHIFT);
